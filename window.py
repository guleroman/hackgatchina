...
class Object_detection_video():
    def main(name):
        ...
        PATH_TO_LABELS = os.path.join(CWD_PATH,'trainedModels','crack_label_map.pbtxt')
...
class Ui_Widget(object):
    ...
    def retranslateUi(self, Widget):
        ...
        self.label_2.setText(_translate("Widget", " Программный модуль детектирования дефектов дороги "))
